@{
    ...
    'Out-ItGlueFlexibleAsset', 'Get-ItGlueOrganization', 'Get-ItGlueOrganizationPasswords', 'Get-ItGluePasswords',
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            ReleaseNotes = 'Updated Get-ItGlueOrganization to 1.0.0.4 (bug fix and log update).'
